...
class Task {
  constructor (props) {
    ...
    this.countSpeedFunc = () => {
      ...
      const speed = Math.max(this.completeSize - this.lastTimeSize, 0) / 2
      this.speed = speed ? Math.floor((this.lastSpeed * 3 + speed) / 4) : 0
      this.lastSpeed = this.speed
      this.averageSpeed = Math.round(this.completeSize / ((new Date()).getTime() - this.startUpload) * 1000 / 2)
